...
export const FetchAllAnalyzedDataByBubbleMap = () => get('http://3.111.39.177/level-one/optimised/data/visualise/bubble-map');
export const FetchAllAnalyzedDataByHour = () => get('http://3.111.39.177/level-one/optimised/data/visualise/hour');
export const fetchAllAnalyzedDataByDay = () => get('http://3.111.39.177/level-one/optimised/data/visualise/day');

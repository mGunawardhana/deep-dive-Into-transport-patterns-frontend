...
import { geAllUsers, saveUser } from '../../service/service';
...
const SignInAndUp = () => {
  ...
  const getAllUsers = async () => {
    try {
      const response = await geAllUsers();
    ...
    <div className="form-container sign-in-container">
      ...
      >
        {({ isSubmitting }) => (<Form className="form">
          ...
          <Field className="input" name="email" placeholder="Email" type="email" />
          <Field className="input" placeholder="Password" name="password" type="password" />
    ...
    <div className="overlay-container">
      <div className="overlay">
        <div className="overlay-panel overlay-left">
          <h3>Welcome Back!</h3>
          <p style={{ fontSize: '16px', fontWeight: '800' }}>To keep connected with us please login with your
            personal info</p>
